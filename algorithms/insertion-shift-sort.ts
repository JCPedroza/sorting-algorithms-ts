/**
 * Sorts number array in-place using Insertion Sort. This version does one comparison
 * and one swap per iteration. Other movements are shifts instead of swaps, having the 
 * data moved around when compared to the swap heavy version.
